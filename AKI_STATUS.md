...
> **History note (Kiro):** this file was rewritten as a short summary in `722824e`, which dropped
> 14 sections of delivery history — P1/P2/P3, AKI 02, AKI 03, A6, the content folded in from the
> stray `docs/AKI_STATUS.md`, rollback points and flagged issues. Restored here from `b02b11b`
