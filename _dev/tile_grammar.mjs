// ==============================================================================
// RETIRED - CHIEF RULING 2026-09-19 04:37. NOT PART OF THE GATE. DO NOT RUN.
//
...
//
// The rule this suite asserts has been REMOVED from the editor. The file is kept,
// byte-identical below this banner, because it is Kiro's work and it records how the
// rule was understood at the time. It will report failures against levels that are
// now CORRECT by Chief's ruling, so it must not gate.
//
// Replaced by _dev/tile_place_explicit.mjs, which asserts the current guarantee:
// the editor stores exactly the tile that was selected, and nothing rewrites it.
//
// PROVENANCE: Orcha overwrote this file at 04:06 by creating a different suite under
// the same name (commit 65f9f5b) without checking whether the filename was taken.
// Restored from a4effaa; the new suite was renamed.
// ==============================================================================
